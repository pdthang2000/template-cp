...
public:
    struct Node {
        ...
        // link is about continuing the automaton.
        // link(u) points to the node representing the longest proper suffix of u that exists in the trie.
        Node* link;      // failure link
        // out is about reporting matches.
        // out(u) points to the nearest suffix of u that is also a complete pattern.
